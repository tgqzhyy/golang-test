...
官方文档https://godoc.org/gopkg.in/alecthomas/kingpin.v2
*/
var (
	app     *kingpin.Application
	service *services.ServiceItem //services 服务
)
...
func initConfig() (err error) {
	...
	app.Author("landv").Version(APP_VERSION) // Author 是修改作者名子，就酱紫
...
func poster() {
	fmt.Printf(`
	 ___             __       _____  ___    ________    ___      ___ 
	|"  |           /""\     (\"   \|"  \  |"      "\  |"  \    /"  |
	||  |          /    \    |.\\   \    | (.  ___  :)  \   \  //  / 
	|:  |         /' /\  \   |: \.   \\  | |: \   ) ||   \\  \/. ./  
	 \  |___     //  __'  \  |.  \    \. | (| (___\ ||    \.    //   
	( \_|:  \   /   /  \\  \ |    \    \ | |:       :)     \\   /    
	 \_______) (___/    \___) \___|\____\) (________/       \__/     
																	 
	v%s`+" by landv , blog : http://landv.cnblogs.com/\n\n", APP_VERSION)
}
